...
<html lang="en">
  ...
  <body>
    ...
    <script src="<?php echo base_url();?>media/js/morris/chart-data-morris.js"></script>
    <script src="<?php echo base_url();?>media/js/tablesorter/jquery.tablesorter.js"></script>
    <script src="<?php echo base_url();?>media/js/tablesorter/tables.js"></script>
